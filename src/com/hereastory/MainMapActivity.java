...
import com.hereastory.util.SystemUiHider;
...
public class MainMapActivity extends Activity {
    ...
    /**
     * If {@link #AUTO_HIDE} is set, the number of milliseconds to wait
     ...
     * Otherwise, will show the system UI visibility upon interaction.
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RasterDataSource dataSource = new HTTPRasterDataSource(
                new EPSG3857(), 0, 18, "http://otile1.mqcdn.com/tiles/1.0.0/osm/{zoom}/{x}/{y}.png");
        ...
        mapView.setFocusPoint(mapView.getLayers().getBaseLayer().getProjection().fromWgs84(35.203543f, 31.774476f));
        // rotation - 0 = north-up
        ...
        // this activity.
        mSystemUiHider =
                SystemUiHider.getInstance(this, mapView, HIDER_FLAGS);
    ...
    protected void onStart() {
        super.onStart();
        // Starts the map - mandatory
        mapView.startMapping();
    }

    @Override
    protected void onStop() {
        // Stops the map - mandatory to avoid problems with app restart
        mapView.stopMapping();
        super.onStop();
    }
