...
public class MapActivity_bo extends Activity implements GooglePlayServicesClient.ConnectionCallbacks, OnMarkerClickListener, OnInfoWindowClickListener, OnCameraChangeListener, OnMyLocationChangeListener, OnResponseRetrieved {
	...
	private final class POIReader implements PointOfInterestReadHandler {
		...
		private void displayErrorPopup() {
			Marker clickedMarker = map.getMarkerShowingInfoWindow();
			updateMarkerInfoWindow(clickedMarker, MapActivity_bo.this.getString(R.string.marker_failed_title), 
					MapActivity_bo.this.getString(R.string.marker_failed_snippet));
		}

		@Override
		public void readCompleted(PointOfInterest poi) {
			Intent hearStoryIntent = new Intent(MapActivity_bo.this, HearStoryActivity.class);
		...
		public void readAllInAreaFailed(double latitude, double longitude,
			...
			MapActivity_bo.this.showExceptionDialog(e);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_bo);
