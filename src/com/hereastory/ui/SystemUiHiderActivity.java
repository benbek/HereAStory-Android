 ...
 * Created by benbek on 8/23/14.
 */
public abstract class SystemUiHiderActivity extends Activity {
    /**
    ...
    protected void setupUiHide(View mainControl, final View controlsView, int activityButtonsId) {
        // Set up an instance of SystemUiHider to control the system UI for
        // this activity.
        mSystemUiHider =
                SystemUiHider.getInstance(this, mainControl, HIDER_FLAGS);
        ...
        // UI.
        mainControl.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(activityButtonsId).setOnTouchListener(
